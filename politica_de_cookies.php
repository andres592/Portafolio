...
<section class="contenedor cookies">
    ...
    <p>El Titular muestra información sobre su Política de cookies en el menú del pie de página y en el banner de cookies accesible en todas las páginas del Sitio Web. El banner de cookies muestra información esencial sobre el tratamiento de datos y permite al Usuario realizar las siguientes acciones:</p>
    <ul>
        <li>ACEPTAR o RECHAZAR la instalación de cookies, o retirar el consentimiento previamente otorgado.</li>
        <li>Obtener información adicional en la página de <a href="">Política de Cookies</a>.</li>
    </ul>
